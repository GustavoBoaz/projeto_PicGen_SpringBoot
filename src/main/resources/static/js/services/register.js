                ...
                if (data.message !== "Email já em uso!") {
                    for (let index = 0; index < data.errors.length; index++) {
                        if (data.errors[index].field === "name") {
                            $('#alert_register').append('<div class="alert borange tbc">Name from 4 to 50 characters</div>');
                        }
                        ...
                        if (data.errors[index].field === "password") {
                            $('#alert_register').append('<div class="alert borange tbc">Password from 4 to 15 characters</div>');
                        }
                    }
                }
